...
$datadir/bin/ycsb load redis -s -P workloads/workloada -p "redis.host=127.0.0.1" -p "redis.port=6379" | awk '{print $2 $3}' > REDISoutLoadA.txt
sleep 5
$datadir/bin/ycsb load redis -s -P workloads/workloada -p "redis.host=127.0.0.1" -p "redis.port=6379" | awk '{print $2 $3}' > REDISoutRunA.txt
sleep 5
$datadir/bin/ycsb load redis -s -P workloads/workloadb -p "redis.host=127.0.0.1" -p "redis.port=6379" | awk '{print $3}' > REDISoutLoadB.txt
sleep 5
